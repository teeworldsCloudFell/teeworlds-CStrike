...
MACRO_TUNING_PARAM(GunLifetime, gun_lifetime, 0.30f)
...
MACRO_TUNING_PARAM(ShotgunLifetime, shotgun_lifetime, 0.30f)

MACRO_TUNING_PARAM(GrenadeCurvature, grenade_curvature, 2.0f)
