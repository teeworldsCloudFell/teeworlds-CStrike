...
void IGameController::Update()
{
    ...
    if(m_PreparTimer && m_IsEnd)
    {
        if(m_PreparTimer % Server()->TickSpeed() == 0)
        {
            ...
            char aBuf[256];
                str_format(aBuf, sizeof(aBuf), "Next Challenge : %d of %d\n%d second%s left\n\nLook at \"/shop\" or at votes\nif you want to buy something",
                           m_RoundCount+1, g_Config.m_SvRoundlimit, m_PreparTimer/Server()->TickSpeed(), m_PreparTimer/Server()->TickSpeed() > 1 ? "s" : "");
...
void IGameController::EndStage()
{
    ...
    if(m_PreparTimer && !m_IsEnd)
    {
        ...
        {
            char aBuf[256];
                str_format(aBuf, sizeof(aBuf), "\n \n \n \nNext Challenge : %d second%s later",
                           m_PreparTimer/Server()->TickSpeed(), m_PreparTimer/Server()->TickSpeed() > 1 ? "s" : "");
