...
class CGameContext : public IGameServer
{
	...
	static void ConAddSpecialVote(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	void CreateDamageInd2(vec2 Pos, float AngleMod, int Amount, int CltMask = -1);
	...
	void HandleOptions(int ClientID, const char* pDesc, const char* pReason);
	bool IsBasicSpecialVote(const char* pDesc);
